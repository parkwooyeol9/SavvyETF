...
COPY analysis.py bot.py stock_crawler.py news_crawler.py etf_names.py ai_briefing.py summary_builder.py summary_analyst.py summary_scheduler.py market_data_freshness.py heatmap.py financial_data.py financial_charts.py financial_pipeline.py dart_data.py dart_charts.py dart_pipeline.py ./
