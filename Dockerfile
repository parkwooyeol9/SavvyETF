...
COPY analysis.py bot.py stock_crawler.py news_crawler.py etf_names.py kr_names.py ai_briefing.py summary_builder.py summary_pdf.py summary_analyst.py summary_scheduler.py summary_pre_builder.py summary_kor_builder.py us_calendar.py market_data_freshness.py heatmap.py financial_data.py financial_charts.py financial_pipeline.py dart_data.py dart_charts.py dart_pipeline.py dart_etf_memb.py dart_etf_memb_charts.py finnhub_market.py yahoo_market.py premarket_rankings.py chart_buffers.py kakao_notify.py ./
...
COPY colab/ETF_Master.xlsx colab/etf_tickers.txt colab/sp500_tickers.txt colab/nasdaq100_tickers.txt colab/kospi200_tickers.txt colab/kosdaq100_tickers.txt colab/
