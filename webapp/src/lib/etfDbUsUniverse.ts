...
export const US_ETF_UNIVERSE_RAW: UsUniverseMeta[] = [
  ...
  { symbol: "XLK", name: "Technology Select", type: "업종/테마", region: "미국", sector: "IT", theme: "업종대표" },
  { symbol: "VGT", name: "Vanguard Information Technology", type: "업종/테마", region: "미국", sector: "IT", theme: "업종대표" },
  { symbol: "XLF", name: "Financial Select", type: "업종/테마", region: "미국", sector: "금융", theme: "업종대표" },
  { symbol: "VFH", name: "Vanguard Financials", type: "업종/테마", region: "미국", sector: "금융", theme: "업종대표" },
  { symbol: "XLV", name: "Health Care Select", type: "업종/테마", region: "미국", sector: "헬스케어", theme: "업종대표" },
  { symbol: "VHT", name: "Vanguard Health Care", type: "업종/테마", region: "미국", sector: "헬스케어", theme: "업종대표" },
  ...
  { symbol: "XLI", name: "Industrial Select", type: "업종/테마", region: "미국", sector: "산업재", theme: "업종대표" },
  { symbol: "VIS", name: "Vanguard Industrials", type: "업종/테마", region: "미국", sector: "산업재", theme: "업종대표" },
  { symbol: "XLY", name: "Consumer Discretionary Select", type: "업종/테마", region: "미국", sector: "경기소비재", theme: "업종대표" },
  { symbol: "VCR", name: "Vanguard Consumer Discretionary", type: "업종/테마", region: "미국", sector: "경기소비재", theme: "업종대표" },
  { symbol: "XLP", name: "Consumer Staples Select", type: "업종/테마", region: "미국", sector: "필수소비재", theme: "업종대표" },
  { symbol: "VDC", name: "Vanguard Consumer Staples", type: "업종/테마", region: "미국", sector: "필수소비재", theme: "업종대표" },
  { symbol: "XLU", name: "Utilities Select", type: "업종/테마", region: "미국", sector: "유틸리티", theme: "업종대표" },
  { symbol: "VPU", name: "Vanguard Utilities", type: "업종/테마", region: "미국", sector: "유틸리티", theme: "업종대표" },
  { symbol: "XLB", name: "Materials Select", type: "업종/테마", region: "미국", sector: "소재", theme: "업종대표" },
  { symbol: "VAW", name: "Vanguard Materials", type: "업종/테마", region: "미국", sector: "소재", theme: "업종대표" },
  { symbol: "XLC", name: "Communication Services Select", type: "업종/테마", region: "미국", sector: "커뮤니케이션", theme: "업종대표" },
  { symbol: "VOX", name: "Vanguard Communication Services", type: "업종/테마", region: "미국", sector: "커뮤니케이션", theme: "업종대표" },
  ...
  { symbol: "FTEC", name: "Fidelity MSCI Information Tech", type: "업종/테마", region: "미국", sector: "IT", theme: "업종대표" },
  { symbol: "IYW", name: "iShares U.S. Technology", type: "업종/테마", region: "미국", sector: "IT", theme: "업종대표" },
