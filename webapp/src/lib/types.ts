...
export const NAV_GROUPS: Array<{
  ...
  { id: "main", label: "메인", tabs: ["main"] },
  {
    id: "market",
    label: "시황",
    tabs: ["kr", "us", "economy", "yencarry", "ideas", "gurus", "eventstudy", "kosdaq100"],
  },
  {
    id: "etf",
    label: "ETF",
    tabs: ["education", "etf", "leverage", "etfdb", "etfweights", "kosdaqactive", "countryetf"],
  },
  {
    id: "portfolio",
    label: "포트폴리오",
    tabs: ["simulate", "usportfolio", "signals", "aiport"],
  },
