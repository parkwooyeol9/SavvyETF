/**
 * Live scrape of single-stock lev ETF trader/investor boards (Naver frgn).
 * Used by the 16:00 KST snapshot job — not by public page loads.
 */
...
export async function buildLevEtfPayload(): Promise<LevEtfPayload> {
  ...
  return {
    ...
    note:
      ...
      "증권사 합산은 종목별 TOP5만(전 회원사 아님). " +
      "거래원 일간 스냅샷은 KRX 거래일 16:00에 R2에 적재되어 히스토리로 조회합니다. " +
