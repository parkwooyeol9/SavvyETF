...
const HEAVY_PATHS: Record<string, { limit: number; windowMs: number }> = {
  ...
  "/api/chart-trade": { limit: 20, windowMs: 60_000 },
  "/api/chart-trade/rank": { limit: 20, windowMs: 60_000 },
  ...
  "/api/market-gamma": { limit: 8, windowMs: 60_000 },
  ...
  "/api/nlp-climate": { limit: 20, windowMs: 60_000 },
  "/api/nlp-dart": { limit: 20, windowMs: 60_000 },
  ...
  "/api/etf-db-us": { limit: 30, windowMs: 60_000 },
