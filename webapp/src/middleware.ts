...
const HEAVY_PATHS: Record<string, { limit: number; windowMs: number }> = {
  ...
  "/api/etf-flow": { limit: 12, windowMs: 60_000 },
  "/api/etf-flow-us": { limit: 12, windowMs: 60_000 },
  "/api/lev-etf": { limit: 30, windowMs: 60_000 },
  "/api/lev-etf/history": { limit: 30, windowMs: 60_000 },
  "/api/lev-etf/snapshot": { limit: 6, windowMs: 60_000 },
  "/api/market-leverage": { limit: 30, windowMs: 60_000 },
